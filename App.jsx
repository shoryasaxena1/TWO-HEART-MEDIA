...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-blue-100 bg-[#F1E4D1] text-[#1F2937]">
      ...
      {/* GLOBAL REEL VIEWER MODAL - FIXED LOGIC */}
      <AnimatePresence>
        {selectedReel && (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {reels.map((reel) => (
            ...
            >
              {/* If it's a thumbnail/image, show that. If it's a direct video link, show frame. */}
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="bg-white p-12 rounded-[3rem] shadow-xl w-full max-w-md text-center">
        ...
        <button onClick={() => val === 'admin' && setPage('dashboard')} className="w-full py-4 bg-[#162660] text-white rounded-xl font-bold uppercase tracking-widest">Enter</button>
      </div>
    </div>
  );
}
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white p-10 rounded-[3rem] border shadow-sm">
               ...
               <div className="space-y-4">
                  ...
                  <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">Supports: YouTube, Vimeo, and MP4 links</p>
               </div>
